...
<body>
	...
	<form action="LoginServlet" method="post" role="form">
		<label>Tipo de Passagem <select><option>Inteira</option>
										<option>Estudante</option>
										<option>Idoso</option></select></label>
		<br><label>Poltrona <input type="text" name="poltrona" value="1"></input></label>
